...
const OutreachDashboard = () => {
  ...
  const isAllowed = true; // Bypassed for local dev - no login required
            ...
            {user ? (
              <>
                <div className="text-muted-foreground">
                  <p className="mb-2">Signed in as <span className="font-medium">{user.email}</span></p>
              ...
              <>
                <p className="text-muted-foreground">Sign in with your Vitrimo team account to access the dashboard.</p>
                <Button
